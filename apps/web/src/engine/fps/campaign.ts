...
//    centred doorways into the room where StillHunt waits. ──
...
const PROTO = 'legendary' as GunId; // the "StillHunt Prototype" — the finale weapon
...
export const CAMPAIGN: Mission[] = [
  ...
  },
  {
    ...
    objectives: twoRoom({ ...C_OBJ, clear2: 'KILL STILLHUNT' }),
  },
];
...
export const CAMPAIGN_KEY = 'stillhunt_mission';   // the op you're currently on
export const PROGRESS_KEY = 'stillhunt_progress';  // the furthest op you've unlocked (soft gating)
