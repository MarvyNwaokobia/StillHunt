...
export class AudioDirector {
   ...
   */
  playVo(id: string, speaker: 'ember' | 'hollow' | 'cinder') {
  ...
  private radioSignature(speaker: 'ember' | 'hollow' | 'cinder') {
    switch (speaker) {
      case 'ember': // close, warm, slightly bright — a friend's channel
        ...
        break;
      case 'hollow': // he doesn't crackle in — the channel drops to make room
