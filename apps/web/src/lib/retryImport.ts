 ...
 *
 * The 3D scenes (HuntScene / GameScene) ship as large dynamic chunks — three.js
...
const RELOAD_KEY = 'stillhunt:chunk-reload-at';
...
/** Preload the first-person /fight scene (HuntScene). */
export function warmFightScene(): void {
  warmChunk('hunt-scene', () => import('@/engine/scene/HuntScene'));
}
